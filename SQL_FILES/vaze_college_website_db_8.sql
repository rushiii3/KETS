...
--
-- Host: localhost
-- Generation Time: Sep 02, 2024 at 04:05 PM
...
CREATE TABLE `achievements` (
  ...
  `achievement_dept_sect_id` int(11) DEFAULT NULL,
  `achievement_committee_sect_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `achievements` (`achievement_id`, `achievement_name`, `achievement_prize`, `achievement_description`, `achievement_achiever_names`, `achievement_date`, `achievement_event`, `achievement_event_location`, `achievement_achieved_by_type`, `achievement_type`, `achievement_dept_sect_id`, `achievement_committee_sect_id`) VALUES
...
(22, NULL, '1st Prize', 'Won 1st Prize in Best Out of Waste in DVITI Fest at SIES College.', 'Ms. Esha Mungalekar, Ms. Pooja Mestry ', '2019', 'Best out of waste in DVITI Fest', 'SIES College, Sion, Mumbai', 's', 'a', NULL, 44);
...
--
-- Table structure for table `committee_has_committee_activities`
--

CREATE TABLE `committee_has_committee_activities` (
  `committee_sect_id` int(11) NOT NULL,
  `committee_act_title` varchar(255) NOT NULL,
  `committee_act_desc` varchar(1000) NOT NULL,
  `committee_act_academic_year` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `committee_has_committee_activities`
--

INSERT INTO `committee_has_committee_activities` (`committee_sect_id`, `committee_act_title`, `committee_act_desc`, `committee_act_academic_year`) VALUES
(44, 'International Yoga Day', 'Celebration of International Yoga Day on 21st June 2019 with an initiative to spread awareness about Yoga through beautiful posters in college campus and a practice session of Yoga.', '2019-2020');

-- --------------------------------------------------------

--
-- Table structure for table `cp_belongs_to_dept_sect`
--

CREATE TABLE `cp_belongs_to_dept_sect` (
  `cp_id` int(11) NOT NULL,
  `dept_sect_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `cp_belongs_to_dept_sect`
--

INSERT INTO `cp_belongs_to_dept_sect` (`cp_id`, `dept_sect_id`) VALUES
(61, 1);
...
CREATE TABLE `departmental_activities` (
  ...
  `dept_act_title` varchar(255) NOT NULL,
  `dept_act_desc` varchar(1000) NOT NULL,
  `dept_act_academic_year` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `departmental_activities` (`dept_act_id`, `dept_act_title`, `dept_act_desc`, `dept_act_academic_year`) VALUES
(1, 'Title', 'accontancy1 2023-2024', '2023-2024'),
(2, 'Title', 'accontancy2 2023-2024', '2023-2024'),
(3, 'Title', 'accontancy1 2024-2025', '2024-2025'),
(4, 'Title', 'accountancy2 2024-2025', '2024-2025'),
(5, 'Title', 'ok1', '2023-2024'),
(6, 'Title', 'ok2', '2021-2022'),
(7, 'Title', 'ok3', '2023-2024'),
(8, 'Dummy Title', 'ok4\r\n', '2024-2025');
...
INSERT INTO `dept_belongs_to_clg_section` (`dept_sect_id`, `dept_id`, `college_sec_name`, `dept_faculty_name`, `dept_link`) VALUES
(1, 1, 's', 's', 'https://sites.google.com/view/it-khand/home'),
(2, 2, 's', 's', NULL),
(3, 3, 'j', 'a', NULL),
(4, 3, 'd', 'a', NULL),
(5, 6, 'd', 'a', NULL),
...
CREATE TABLE `other_pdfs` (
  ...
  `all_pdf_pdf_link` varchar(2000) NOT NULL,
  `all_pdf_upload_date` date NOT NULL,
  `other_pdfs_should_it_be_visible` enum('y','n') NOT NULL DEFAULT 'y',
...
(1, 'FYBSCIT NEP 2024-2025', 'https://vazecollege.net/wp-content/uploads/2023/Syllabus/Open%20Eletive%20Offered%20to%20other%20Departments%202023-2024%20NEP.pdf', '2024-06-01', 'y', 'syllabus'),
(2, 'SYBSCIT NEP 2024 2025', 'http://vazecollege.net/wp-content/uploads/2024/syllabus/SYBScIT%20NEP%202024%202025.pdf', '2024-06-01', 'y', 'syllabus'),
(3, 'TYBSCIT NEP 2024-2025', 'http://vazecollege.net/wp-content/uploads/2024/syllabus/TYIT_2024_2025.pdf', '2024-06-01', 'y', 'syllabus'),
(4, 'FYBSCIT 2022-2021', 'http://vazecollege.net/wp-content/uploads/2020/10/FYBScIT.pdf', '0000-00-00', 'y', 'syllabus'),
(5, 'SYBSCIT 2022-2021', 'http://vazecollege.net/wp-content/uploads/2020/10/SYBSc.pdf', '0000-00-00', 'y', 'syllabus'),
(6, 'TYBSCIT 2022-2021', 'http://vazecollege.net/wp-content/uploads/2020/10/TYBSc-IT.pdf', '0000-00-00', 'y', 'syllabus'),
(7, 'MSCIT PART-I 2020-2021', 'http://vazecollege.net/wp-content/uploads/2020/10/M.Sc-IT_Part_1_sem_I_SemII.pdf', '0000-00-00', 'y', 'syllabus'),
(8, 'MSCIT PART-II 2020-2021', 'http://vazecollege.net/wp-content/uploads/2020/10/M.Sc-IT_Part_2_sem_III_Sem_IV.pdf', '0000-00-00', 'y', 'syllabus'),
(9, 'Attestation', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Attestation.pdf', '2023-01-01', 'y', 'procedures'),
(10, 'Backlog Certificate', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Backlog%20Certificate.pdf', '2023-01-01', 'y', 'procedures'),
(11, 'Bonafide Certificate', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Bonafide%20Certificate.pdf', '2023-01-01', 'y', 'procedures'),
(12, 'Letter of Recommendation', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Letter%20of%20Recommendation.pdf', '2023-01-01', 'y', 'procedures'),
(13, 'Medium of Instruction', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Medium%20of%20Instruction.pdf', '2023-01-01', 'y', 'procedures'),
(14, 'NOC for Visa', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/NOC%20for%20Visa.pdf', '2023-01-01', 'y', 'procedures'),
(15, 'No Objection Certificate for Academic', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/No%20Objection%20Certificate%20for%20Academic.pdf', '2023-01-01', 'y', 'procedures'),
(16, 'Provisional Graduation Certification', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Provisional%20Graduation%20Certificate.pdf', '2023-01-01', 'y', 'procedures'),
(17, 'Transcript', 'https://www.vazecollege.net/wp-content/uploads/2023/Procedures/Transcript.pdf', '2023-01-01', 'y', 'procedures'),
(18, 'Mayur Magazine Transition Issue', 'http://vazecollege.net/wp-content/uploads/2022/12/Mayur%20Magazine_Transition%20Issue.pdf', '2022-12-01', 'y', 'magazine'),
(19, 'Mayur Magazine 2019-20', 'http://vazecollege.net/wp-content/uploads/2020/05/MayurMagzine_2019_20.pdf', '2020-05-01', 'y', 'magazine'),
(20, 'PSOs AND POs – SCIENCE', 'https://vazecollege.net/wp-content/uploads/2020/10/PSOS-AND-POS-SCIENCE.pdf', '2020-10-01', 'y', 'POs_and_PSOs'),
(21, 'PSOs AND POs – COMMERCE', 'https://vazecollege.net/wp-content/uploads/2020/10/PSOS-AND-POS-COMMERCE.pdf', '2020-10-01', 'y', 'POs_and_PSOs'),
(22, 'PSOs AND POs – ARTS', 'http://vazecollege.net/wp-content/uploads/2020/10/PSOS-AND-POS-ARTS-.pdf', '2020-10-01', 'y', 'POs_and_PSOs'),
(23, 'Academic Calendar 2023-2024', 'http://vazecollege.net/wp-content/uploads/2023/07/ACADEMIC-CALENDAR-2023-2024.pdf', '2023-07-01', 'y', 'academic_calendar'),
(24, 'Academic Calendar 2022-2023', 'http://vazecollege.net/wp-content/uploads/2023/08/Academic-Calender-2022-2023.pdf', '2023-08-01', 'y', 'academic_calendar'),
(25, 'Academic Calendar 2021-2022', 'http://vazecollege.net/wp-content/uploads/2022/03/Academic_Calendar_for_2021_2022.pdf', '2022-03-01', 'y', 'academic_calendar'),
(26, 'Academic Calendar 2020-2021', 'http://vazecollege.net/wp-content/uploads/2022/03/Academic_Calendar_for_2020_2021.pdf', '2022-03-01', 'y', 'academic_calendar'),
(27, 'Academic Calendar 2019-2020', 'http://vazecollege.net/wp-content/uploads/2019/Academic_Calender%202019%202020.pdf', '2019-01-01', 'y', 'academic_calendar'),
(28, 'Academic Calendar 2018-2019', 'http://vazecollege.net/wp-content/uploads/2019/Academic_Calender%202018%202019.pdf', '2019-01-01', 'y', 'academic_calendar'),
(29, 'Aided prospectus 2024-2025', 'https://www.vazecollege.net/wp-content/uploads/2024/pdf/AIDED%20PROSPECTUS%202024-2025%20Revised.pdf', '2024-05-01', 'y', 'prospectus'),
(30, 'Prospectus Aided College 2023-2024', 'https://www.vazecollege.net/wp-content/uploads/2023/PDFs/AIDED%20PROSPECTUS%20ACADEMIC%20YEAR%202023-24%20Revised.pdf', '2023-05-01', 'y', 'prospectus'),
(31, 'Brochure', 'https://www.vazecollege.net/wp-content/uploads/2020/08/Brochure-FTP-Revised-VM.pdf', '2022-01-01', 'y', 'brochure'),
(32, 'MSCIT Part-1 NEP 2023-2024', 'http://vazecollege.net//wp-content/uploads/2023/Syllabus/M.Sc.%20IT%20Sem%20I%20and%20II%20(NEP)%202023%202024.pdf', '2023-05-01', 'y', 'syllabus');

-- --------------------------------------------------------

--
-- Table structure for table `other_pdf_belongs_to_academic_year`
--

CREATE TABLE `other_pdf_belongs_to_academic_year` (
  `other_pdf_id` int(11) NOT NULL,
  `academic_year` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `other_pdf_belongs_to_academic_year`
--

INSERT INTO `other_pdf_belongs_to_academic_year` (`other_pdf_id`, `academic_year`) VALUES
(23, '2023-2024'),
(24, '2022-2023'),
(25, '2021-2022'),
(26, '2020-2021'),
...
--
-- Table structure for table `other_pdf_cover_page_links`
--

CREATE TABLE `other_pdf_cover_page_links` (
  `other_pdf_id` int(11) NOT NULL,
  `other_pdf_cover_page_link` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `other_pdf_cover_page_links`
--

INSERT INTO `other_pdf_cover_page_links` (`other_pdf_id`, `other_pdf_cover_page_link`) VALUES
(18, 'transition_issue_2020.webp'),
(19, 'mm_19_20.webp'),
(31, 'brochure_img.webp');
...
--
-- Dumping data for table `other_pdf_is_for_clg_section_in_academic_year`
--

INSERT INTO `other_pdf_is_for_clg_section_in_academic_year` (`other_pdf_id`, `college_sec_name`, `academic_year`) VALUES
(29, 'd', '2024-2025'),
(30, 'd', '2023-2024');
...
CREATE TABLE `reports` (
  ...
  `all_pdf_pdf_link` varchar(2000) NOT NULL,
  `all_pdf_upload_date` date NOT NULL,
  `reports_should_it_be_visible` enum('y','n') NOT NULL DEFAULT 'y',
  `reports_type` enum('aqar','caqar','ssr','iqac','nirf','aishe') NOT NULL,
  `reports_academic_year` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reports` (`all_pdf_id`, `all_pdf_title`, `all_pdf_pdf_link`, `all_pdf_upload_date`, `reports_should_it_be_visible`, `reports_type`, `reports_academic_year`) VALUES
(1, 'SSR 2012-2017 4th cycle', 'http://vazecollege.net/wp-content/uploads/2022/iqac/SSR%202012-2017%20fourth%20cycle.pdf', '2022-01-01', 'y', 'ssr', NULL),
(2, 'SSR 1998', 'http://vazecollege.net/wp-content/uploads/2022/iqac/SSR%201998.pdf', '2022-01-01', 'y', 'ssr', NULL),
(3, 'IQAC MOM_IQAC ATR_22-23', 'https://www.vazecollege.net/wp-content/uploads/2023/iqac/IQAC%20MOM_IQAC%20ATR_22-23.pdf', '2023-01-01', 'y', 'iqac', '2022-2023'),
(4, 'IQAC Formation 22-23', 'https://www.vazecollege.net/wp-content/uploads/2023/iqac/Composition_22-23.pdf', '2023-01-01', 'y', 'iqac', '2022-2023'),
(5, 'IQAC Formation', 'https://www.vazecollege.net/wp-content/uploads/2022/iqac/IQAC%20Formation.pdf', '2022-01-01', 'y', 'iqac', '2021-2022'),
(6, 'IQAC Minutes of Meeting and ATR 21-22', 'https://www.vazecollege.net/wp-content/uploads/2022/iqac/IQAC%20Minutes%20of%20Meeting_ATR%2021_22.pdf', '2022-01-01', 'y', 'iqac', '2021-2022'),
(7, 'IQAC Formation', 'https://www.vazecollege.net/wp-content/uploads/2022/03/IQAC%20Formation%202020-21.pdf', '2022-03-01', 'y', 'iqac', '2020-2021'),
(8, 'IQAC Minutes of Meeting', 'https://www.vazecollege.net/wp-content/uploads/2022/03/IQAC%20Minutes%20of%20Meeting%202020-21.pdf', '2022-03-01', 'y', 'iqac', '2020-2021'),
(9, 'Academic Calendar', 'https://www.vazecollege.net/wp-content/uploads/2022/03/Academic_Calendar_for_2020_2021.pdf', '2022-03-01', 'y', 'iqac', '2020-2021'),
(10, 'Institutional Best Practices', 'http://vazecollege.net/wp-content/uploads/2020/10/7.2.1_Best_Practices_2019-20.pdf', '2020-10-01', 'y', 'iqac', '2019-2020'),
(11, 'Institutional Distinctivness', 'http://vazecollege.net/wp-content/uploads/2020/10/7.3.1_Institutional_Distinctiveness.pdf', '2020-10-01', 'y', 'iqac', '2019-2020'),
(12, 'IQAC Formation', 'http://vazecollege.net/wp-content/uploads/2019/10/IQAC_Formation_Latest.pdf', '2019-10-01', 'y', 'iqac', '2019-2020'),
(13, 'IQAC Minutes of Meeting 2019-20', 'http://vazecollege.net/wp-content/uploads/2020/10/Minutes%20of%20meeting%202019-20%20ATR.pdf', '2020-10-01', 'y', 'iqac', '2019-2020'),
(14, 'Programme outcomes 2019-20', 'https://vazecollege.net/wp-content/uploads/2021/05/Programme%20outcomes%202019-20.pdf', '2021-05-01', 'y', 'iqac', '2019-2020'),
(15, 'Students Satisfaction Survey (SSS) 2019-20', 'http://vazecollege.net/wp-content/uploads/2021/05/Students%20Support%20System%20Feedback%202019-20.pdf', '2021-05-01', 'y', 'iqac', '2019-2020'),
(16, 'Policies and Procedures 2019-2020', 'http://vazecollege.net/wp-content/uploads/2021/05/Policies%20and%20Procedures%202019-2020.pdf', '2021-05-01', 'y', 'iqac', '2019-2020'),
(17, 'Teachers Code of Conduct', 'http://vazecollege.net/wp-content/uploads/2021/05/Teachers_code_of_conduct%20_2019-20.pdf', '2021-05-01', 'y', 'iqac', '2019-2020'),
(18, 'Institutional Best Practices', 'http://vazecollege.net/wp-content/uploads/2019/12/Institutional-Best-Practices.pdf', '2019-12-01', 'y', 'iqac', '2018-2019'),
(19, 'Institutional Distinctivness', 'http://vazecollege.net/wp-content/uploads/2019/12/Institutional-Distinctivness.pdf', '2019-12-01', 'y', 'iqac', '2018-2019'),
(20, 'IQAC Formation', 'http://vazecollege.net/wp-content/uploads/2019/10/IQAC_Formation_Latest.pdf', '2019-10-01', 'y', 'iqac', '2018-2019'),
(21, 'IQAC Minutes of Meeting', 'http://vazecollege.net/wp-content/uploads/2019/10/MM_IQAC.pdf', '2019-10-01', 'y', 'iqac', '2018-2019'),
(22, 'Procedure and Proposal', 'http://vazecollege.net/wp-content/uploads/2019/12/Procedure-Proposal-1.pdf', '2019-12-01', 'y', 'iqac', '2018-2019'),
(23, 'Program Outcome', 'http://vazecollege.net/wp-content/uploads/2019/11/Program_Outcome.pdf', '2019-11-01', 'y', 'iqac', '2018-2019'),
(24, 'Students Support System Feedback', 'http://vazecollege.net/wp-content/uploads/2020/01/SSS_Feedback_2018_2019.pdf', '2020-01-01', 'y', 'iqac', '2018-2019'),
(25, 'Field Projects Visits ', 'http://vazecollege.net/wp-content/uploads/2023/iqac/1.3.4%20Field%20projects-visits.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(26, 'Mapping and Attainment 2022-2023', 'http://vazecollege.net/wp-content/uploads/2023/iqac/Mapping%20and%20Attainment%202022-2023.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(27, 'Student Satisfaction Survey 2022-2023', 'http://vazecollege.net/wp-content/uploads/2023/iqac/2.7.1_Student%20Satisfaction%20Survey%202022-2023.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(28, 'Reports of Workshops Conducted_Associations', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Associations.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(29, 'Reports of Workshops Conducted_Arts and Humanities', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Arts%20and%20Humanities.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(30, 'Reports of Workshops Conducted_BVOC', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_BVOC.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(31, 'Reports of Workshops Conducted_Commerce', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Commerce.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(32, 'Reports of Workshops Conducted_PGDPCM', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_PGDPCM.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(33, 'Reports of Workshops Conducted_Science', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Science.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(34, 'Report of Workshops Conducted _SFC', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.3.2_Report%20of%20Workshops%20Conducted%20_SFC.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(35, 'Reports of Extension Activities', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.6.3_Reports%20of%20Extension%20Activities.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(36, 'Documents of Collabrative Activities', 'http://vazecollege.net/wp-content/uploads/2023/iqac/3.7.1_Documents%20of%20Collabrative%20Activities.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(37, 'ICT Enabled facilities 2022-2023 ', 'http://vazecollege.net/wp-content/uploads/2023/iqac/4.2.2%20and%204.2.3%20-E-Library%20Resources%20and%20ebooks.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(38, 'E-Library Resources and ebooks', 'http://vazecollege.net/wp-content/uploads/2023/iqac/4.2.2%20and%204.2.3%20-E-Library%20Resources%20and%20ebooks.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(39, 'Implementation of E governance ', 'http://vazecollege.net/wp-content/uploads/2023/iqac/6.2.3_Implementation%20of%20E%20governance.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(40, 'Audited Balance Sheet', 'http://vazecollege.net/wp-content/uploads/2023/iqac/6.4.2%20and%206.4.3%20Audited%20Balance%20Sheet.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(41, 'Gender Equity', 'http://vazecollege.net/wp-content/uploads/2023/iqac/7.1.1%20GENDER%20EQUITY_2022-23.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(42, 'Best Practices', 'http://vazecollege.net/wp-content/uploads/2023/iqac/7.2%20Best%20Practices.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(43, 'Institutional Distinctiveness', 'http://vazecollege.net/wp-content/uploads/2023/iqac/7.3%20INSTITUTIONAL%20DISTINCTIVENESS_2022-23.pdf', '2023-01-01', 'y', 'caqar', '2022-2023'),
(44, 'Arts BOS Meeting Minutes 21-22', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.2.2%20Arts%20BOS%20Meeting%20Minutes%2021-22.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(45, 'SCIENCE BOS Meeting Minutes 21-22', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.2.2%20SCIENCE%20BOS%20Meeting%20Minutes%2021-22.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(46, 'COMMERCE BOS Meeting Minutes 21-22', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.2.2COMMERCE%20BOS%20Meeting%20Minutes%2021-22.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(47, 'SFC BOS Meeting Minutes 21-22', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.2.2%20SFC%20BOS%20Meeting%20Minutes%2021-22.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(48, 'Project-Internship', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.3.4_Project-Internship.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(49, 'Structured feedback and review of the syllabus', 'http://vazecollege.net/wp-content/uploads/2022/iqac/1.4.1%20and%201.4.2%20Structured%20feedback%20and%20review%20of%20the%20syllabus.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(50, 'PO-PSO-CO 2021-2022', 'http://vazecollege.net/wp-content/uploads/2022/iqac/2.6.1_PO-PSO-CO_2021-2022.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(51, 'Student Satisfication Survey 2021-2022', 'http://vazecollege.net/wp-content/uploads/2022/iqac/2.7.2_Student%20Satisfication%20Survey%202021-2022.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(52, 'Research Promotion Policies', 'http://vazecollege.net/wp-content/uploads/2022/iqac/Research%20Promotion%20Policies.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(53, 'Reports of Workshops Conducted – Associations', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Associations.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(54, 'Reports of Workshops Conducted – Humanities', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Humanities.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(55, 'Report of workshop-Commerce', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.3%20.2%20Report%20of%20workshop.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(56, 'Reports of Workshops Conducted – Science', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_Science.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(57, 'Reports of Workshops Conducted – SFC', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.3.2_Reports%20of%20Workshops%20Conducted_SFC.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(58, 'Research Promotion Policies', 'http://vazecollege.net/wp-content/uploads/2022/iqac/Research%20Promotion%20Policies.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(59, 'Reports of Extension Activities.pdf', 'http://vazecollege.net/wp-content/uploads/2022/iqac/3.6.3_Reports%20of%20Extension%20Activities.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(60, 'ICT enabled Facilities 2021-2022', 'http://vazecollege.net/wp-content/uploads/2022/iqac/4.1.3%20ICT%20enabled%20Facilities_2021-2022.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(61, 'Details of Subscription', 'http://vazecollege.net/wp-content/uploads/2022/iqac/4.2.2%20Details%20of%20Subscription.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(62, 'Details of Student benefited by Scholarship', 'http://vazecollege.net/wp-content/uploads/2022/iqac/Details%20of%20Student%20benefited%20by%20Scholarship.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(63, 'Details of Student benefited by Scholarship', 'http://vazecollege.net/wp-content/uploads/2022/iqac/Details%20of%20Student%20benefited%20by%20Scholarship.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(64, 'Capacity Development and Skill Enhancement', 'http://vazecollege.net/wp-content/uploads/2022/iqac/5.1.3%20Capacity%20Development%20and%20Skill%20Enhancement.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(65, 'Guidance for Competitive Exams', 'http://vazecollege.net/wp-content/uploads/2022/iqac/5.1.4%20Guidance%20for%20Competitive%20Exams.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(66, 'Number of benefited students by career counseling activities', 'http://vazecollege.net/wp-content/uploads/2022/iqac/5.1.4%20No%20of%20benefited%20students%20by%20career%20counseling%20activities.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(67, 'Audited Statement', 'http://vazecollege.net/wp-content/uploads/2022/iqac/Audited%20Statement.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(68, 'Committee list and strategic plan', 'http://vazecollege.net/wp-content/uploads/2022/iqac/6.1.2%20Committee%20list%20and%20strategic%20plan.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(69, 'Implementation of E governance', 'http://vazecollege.net/wp-content/uploads/2022/iqac/6.2.3%20Implementation%20of%20E%20governance.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(70, 'Scholarship Data', 'http://vazecollege.net/wp-content/uploads/2022/iqac/6.4.2%20Scholarship%20Data.pdf', '2022-01-01', 'y', 'caqar', '2021-2022'),
(71, 'Best Practices', 'http://vazecollege.net/wp-content/uploads/2022/03/7.2%20BEST%20PRACTICES.pdf', '2022-03-01', 'y', 'caqar', '2021-2022'),
(72, 'Institutional Best Practices', 'http://vazecollege.net/wp-content/uploads/2022/03/7.3%20-%20INSTITUTIONAL%20DISTINCTIVENESS.pdf', '2022-03-07', 'y', 'caqar', '2021-2022'),
(73, 'COMMERCE BOS Minutes of Meeting', 'http://vazecollege.net/wp-content/uploads/2022/03/1.1.2_COMMERCE_BOS_Minutes_of_Meeting.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(74, 'History BOS Minutes of Meeting', 'http://vazecollege.net/wp-content/uploads/2022/03/1.1.2_History_BOS_Minutes_of_Meeting.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(75, 'Physics BOS Minutes of Meeting', 'http://vazecollege.net/wp-content/uploads/2022/03/1.1.2_Physics_BOS_Minutes_of_Meeting.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(76, 'Minutes of BOS Meetings 2020 21', 'http://vazecollege.net/wp-content/uploads/2022/03/1.2.2_Minutes_of_BOS_Meetings_2020_21.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(77, 'CA internship Data', 'http://vazecollege.net/wp-content/uploads/2022/03/1.3.4_CA_internship_Data.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(78, 'PGDPCM Internship Data', 'http://vazecollege.net/wp-content/uploads/2022/03/1.3.4_PGDPCM_Internship_Data.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(79, 'Political Science Internship Data', 'http://vazecollege.net/wp-content/uploads/2022/03/1.3.4_Pol_Sci_Internship_Data.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(80, 'Structured feedback and review of the syllabus', 'http://vazecollege.net/wp-content/uploads/2022/03/1.4.1%20-%20Structured%20feedback%20and%20review%20of%20the%20syllabus.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(81, 'The feedback system of the Institution', 'http://vazecollege.net/wp-content/uploads/2022/03/1.4.2%20-%20The%20feedback%20system%20of%20the%20Institution.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(82, 'PO_PSO_CO', 'http://vazecollege.net/wp-content/uploads/2022/03/2.6.1_PO_PSO_CO.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(83, 'Student Satisfaction Survey 2020-2021', 'http://vazecollege.net/wp-content/uploads/2022/03/2.7.1_Student_Satisfaction_Survey_2020-2021.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(84, 'Research Methodology and Skill Development Courses_Science', 'http://vazecollege.net/wp-content/uploads/2022/03/3.3.2_Research%20Methodololy%20and%20Skill%20Development%20Courses_Science.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(85, 'Research Methodology and Skill Development Courses_SFC', 'http://vazecollege.net/wp-content/uploads/2022/03/3.3.2_Research%20Methodololy%20and%20Skill%20Development%20Courses_SFC.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(86, 'Research Methodololy and Skill Development Courses Commerce ', 'http://vazecollege.net/wp-content/uploads/2022/03/3.3.2_Research%20Methodololy%20and%20Skill%20Development%20Courses_Commerce.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(87, 'Research Methodololy and Skill Development Courses Associations', 'http://vazecollege.net/wp-content/uploads/2022/03/3.3.2_Research%20Methodololy%20and%20Skill%20Development%20Courses_Associations.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(88, 'Research Methodololy and Skill Development Courses_Humanities', 'http://vazecollege.net/wp-content/uploads/2022/03/3.3.2_Research%20Methodololy%20and%20Skill%20Development%20Courses_Humanities.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(89, 'CARE List', 'http://vazecollege.net/wp-content/uploads/2022/03/3.4.3_CARE%20List.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(90, 'Collaboration Document', 'http://vazecollege.net/wp-content/uploads/2022/03/3.7.1_Collaboration%20Document.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(91, 'ICT-enabled facilities', 'http://vazecollege.net/wp-content/uploads/2022/03/4.1.3_ICT_enabled_facilities.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(92, 'Details of Subscription', 'http://vazecollege.net/wp-content/uploads/2022/03/4.2.2_Details_of_Subscription.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(93, 'Government Scholorship', 'http://vazecollege.net/wp-content/uploads/2022/03/5.1.1%20Government%20Scholorship.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(94, 'Institutional & NGO Scholarship', 'http://vazecollege.net/wp-content/uploads/2022/03/5.1.2%20Institutional%20&%20NGO%20Scholorship.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(95, 'Placements', 'http://vazecollege.net/wp-content/uploads/2022/03/5.1.4_Placements.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(96, 'Kelkar Vaze Alumni Association', 'http://vazecollege.net/wp-content/uploads/2022/03/5.4.1_Kelkar%20Vaze%20Alumni%20Association.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(97, 'Regular PROSPECTUS Aided', 'http://vazecollege.net/wp-content/uploads/2022/03/6.1.2%20Regular%20PROSPECTUS_Aided_20-21.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(98, '(b) – Committee List6.2.3 Implementation of E governance', 'http://vazecollege.net/wp-content/uploads/2022/03/6.2.3%20Implementation%20of%20E%20governance.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(99, 'Audited Statement', 'http://vazecollege.net/wp-content/uploads/2022/03/6.4.2%20-%20Audited%20Statement.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(100, 'Induction Programme', 'http://vazecollege.net/wp-content/uploads/2022/03/6.5.3%20-%20Induction%20Programme.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(101, 'Institutional Best Practices', 'http://vazecollege.net/wp-content/uploads/2022/03/7.2.1_Institutional_Best_Practices.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(102, 'Institutional Distinctiveness', 'http://vazecollege.net/wp-content/uploads/2022/03/7.3.1_Institutional_Distinctiveness.pdf', '2022-03-01', 'y', 'caqar', '2020-2021'),
(103, 'NIRF Report College 2023 – 2024', 'http://vazecollege.net/wp-content/uploads/2023/PDFs/The%20KETs%20Vinayak%20Ganesh%20Vaze%20College%20of%20Arts%20Science%20and%20CommerceNIRF%20REPORT%20COLLEGE%20LEVEL%202023-24.pdf', '2023-01-01', 'y', 'nirf', '2023-2024'),
(104, 'NIRF Report Overall 2023 – 2024', 'http://vazecollege.net/wp-content/uploads/2023/PDFs/The%20KETs%20Vinayak%20Ganesh%20Vaze%20College%20of%20Arts%20Science%20and%20CommerceNIRF%20REPORT%20OVERALL%202023-24.pdf', '2023-01-01', 'y', 'nirf', '2023-2024'),
(105, 'NIRF Report 2022 – 2023', 'http://vazecollege.net/wp-content/uploads/2023/PDFs/The%20KETs%20Vinayak%20Ganesh%20Vaze%20College%20of%20Arts%20Science%20and%20Commerce20230217.pdf', '2023-01-01', 'y', 'nirf', '2022-2023'),
(106, 'NIRF Report 2021 – 2022', 'http://vazecollege.net/wp-content/uploads/2022/02/Revised_Final_NIRF_Data_Feb_2022.pdf', '2022-02-01', 'y', 'nirf', '2021-2022'),
(107, 'NIRF Report 2020 – 2021', 'http://vazecollege.net/wp-content/uploads/2022/02/NIRF_2021.pdf', '2022-02-01', 'y', 'nirf', '2020-2021'),
(108, 'NIRF Report 2019 – 2020', 'http://vazecollege.net/wp-content/uploads/2021/01/NIRF_2019_2020.pdf', '2021-01-01', 'y', 'nirf', '2019-2020'),
(109, 'NIRF Report 2017 – 2018', 'http://vazecollege.net/wp-content/uploads/2018/12/Overall-Report-Final-Submission.pdf', '2018-12-01', 'y', 'nirf', '2017-2018'),
(110, 'NIRF Report 2016 – 2017', 'http://vazecollege.net/wp-content/uploads/2017/12/All-Report-MHRD-National-Institutional-Ranking-Framework-NIRF-1.pdf', '2017-12-01', 'y', 'nirf', '2016-2017'),
(111, 'NIRF Report 2015 – 2016', 'http://vazecollege.net/wp-content/uploads/2016/11/nirf-report-1.pdf', '2016-11-01', 'y', 'nirf', '2015-2016'),
(112, 'AQAR 2022-2023', 'http://vazecollege.net/wp-content/uploads/2022/iqac/AQAR%202022-2023.pdf', '2022-01-01', 'y', 'aqar', '2022-2023'),
(113, 'AQAR 2021-2022', 'http://vazecollege.net/wp-content/uploads/2023/PDFs/AQAR%202021-22.pdf', '2023-01-01', 'y', 'aqar', '2021-2022'),
(114, 'AQAR 2020-2021', 'http://vazecollege.net/wp-content/uploads/2022/08/AQAR%202020-21.pdf', '2022-08-01', 'y', 'aqar', '2020-2021'),
(115, 'AQAR 2019-2020', 'http://vazecollege.net/wp-content/uploads/2021/08/AQAR_2019_20.pdf', '2021-08-01', 'y', 'aqar', '2019-2020'),
(116, 'AQAR 2018-2019', 'http://vazecollege.net/wp-content/uploads/2020/10/AQAR%202018-19.pdf', '2020-10-01', 'y', 'aqar', '2018-2019'),
(117, 'AQAR 2017-2018', 'http://vazecollege.net/wp-content/uploads/2019/10/AQAR-17-18.pdf', '2019-10-01', 'y', 'aqar', '2017-2018'),
(118, 'AQAR 2016-2017', 'http://vazecollege.net/wp-content/uploads/2019/10/AQAR-16-17.pdf', '2019-10-01', 'y', 'aqar', '2016-2017'),
(119, 'AQAR 2015-2016', 'https://www.vazecollege.net/wp-content/uploads/2016/11/AQAR-Report-13246-V.G.Vaze-College-2015-16.pdf', '2016-11-01', 'y', 'aqar', '2015-2016'),
(120, 'AQAR 2013-2014', 'http://vazecollege.net/wp-content/uploads/2016/01/AQAR_2013-14.pdf', '2016-01-01', 'y', 'aqar', '2013-2014'),
(121, 'AQAR 2007-2008', 'http://vazecollege.net/wp-content/uploads/2016/01/iqacreport2008.pdf', '2016-01-01', 'y', 'aqar', '2007-2008'),
(122, 'AQAR 2006-2007', 'http://vazecollege.net/wp-content/uploads/2016/01/iqacreport2007.pdf', '2016-01-01', 'y', 'aqar', '2006-2007'),
(123, 'AQAR 2005-2006', 'http://vazecollege.net/wp-content/uploads/2016/01/iqacreport2006.pdf', '2016-01-01', 'y', 'aqar', '2005-2006');
...
--
-- Dumping data for table `reports_belong_to_aqar_criteria`
--

INSERT INTO `reports_belong_to_aqar_criteria` (`report_id`, `aqar_criteria_number`, `aqar_sub_criteria`) VALUES
(25, 1, '1.3.4'),
(26, 2, '-'),
(27, 2, '2.7.1'),
(28, 3, '3.3.2'),
...
CREATE TABLE `scholarships` (
  ...
  `scholarship_type` enum('gs','gf','csaf','es','merit') NOT NULL,
  `scholarship_eligibility` varchar(100) DEFAULT NULL,
  `scholarship_students_awarded` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `scholarships` (`scholarship_id`, `scholarship_name`, `scholarship_type`, `scholarship_eligibility`, `scholarship_students_awarded`) VALUES
(1, 'Govt. Open merit Scholarship', 'gs', NULL, NULL),
(2, 'National Merit Scholarship', 'gs', NULL, NULL),
(3, 'National Talent Search Scholarship', 'gs', NULL, NULL),
(4, 'Financial aid to Scholars', 'gs', NULL, NULL),
(5, 'National Loan Scholarship', 'gs', NULL, NULL),
(6, 'S.C.B.C. Students Scholarship', 'gs', NULL, NULL),
(7, 'E.B.C.Scholarship', 'gs', NULL, NULL),
(8, 'S.T.Students Scholarship', 'gs', NULL, NULL),
(9, 'P.T.W.; S.T.W. Scholarship', 'gs', NULL, NULL),
(10, 'SC/ST Scholarship', 'gs', 'Income less than 1 lac', NULL),
(11, 'NT/SBC/OBC Students Scholarship', 'gs', 'Income less than Rs. 65290 p.a', NULL),
(12, 'E.B.C.Freeship', 'gf', NULL, NULL),
(13, 'SC/ST Students Freeship', 'gf', 'Income more than 1 Lac', NULL),
(14, 'NT/SBC Student Freeship ', 'gf', 'Income greater than Rs. 65290 p.a.', NULL),
(15, 'S.T. Student Freeship', 'gf', NULL, NULL),
(16, 'P.T.W. Freeship (Provisional)', 'gf', NULL, NULL),
(17, 'S.T.W.Freeship (Provisional)', 'gf', NULL, NULL),
(18, 'OBC Freeship', 'gf', 'Income between Rs. 65291 and 3 lacs', NULL),
(19, 'Ramu S. Deora Scholarship', 'csaf', NULL, 20),
(20, 'T.N.Venkateshan Chemistry Scholarship', 'csaf', NULL, 21),
(63, 'Sunil Deodhar Memorial Sports Scholarship', 'es', NULL, 5),
(64, 'Sandeep Kanakgiri Memorial “CPM” Scholarship', 'es', NULL, 1),
(65, 'Shakuntala DamodarUmrani Scholarship', 'es', NULL, 3),
(66, 'Damodar Umrani Memorial Scholarship', 'es', NULL, 2),
(67, 'Dr.P.D. Bhave Memorial Scholarship', 'es', NULL, 1),
(68, 'Late Vinaya Gangurde Memorial Scholarship', 'es', NULL, 1),
(69, 'M.S. Shanbhag Memorial Scholarship', 'es', NULL, 1),
(70, 'Kelkar-Vaze-SMAF Freeship for needy students', 'es', NULL, NULL),
(71, 'S.H.Kelkar Memorial Scholarship for Class Toppers', 'es', 'all classes', NULL),
(72, 'T.R. Mulla Memorial Scholarship', 'es', NULL, 10),
(73, 'Radhabai Vaze Memorial Scholarship for Girls', 'es', NULL, 5),
(74, 'Radhabai Vaze Memorial Freeship for Needy', 'es', NULL, 5),
(75, 'Dr.R.A.Kulkarni Memorial Scholarship   (for VCTS toppers)', 'es', NULL, NULL),
(76, 'G.D.Gokhale Memorial Endowment (needy/deserving', 'es', NULL, 20),
(77, 'Late Shri Lalji Karamshi Shah Endowment (deserving)', 'es', NULL, 1),
(78, 'Fakruddin Adamally Endowment Scholarship for General/ Sports/ Needy/ Deserving students', 'es', NULL, 20),
(79, 'Sujata Pabrekar Memorial Scholarship  ( NSS/ Extra Curricular )', 'es', NULL, 2),
(80, 'Shaku-la Arts Endowment Prize for Excellence in Fine Arts', 'es', NULL, 2),
(81, 'Trimbak Keshav Kawale (Ozarkar) endowments to meritorious students offering Physics', 'es', NULL, 3),
(82, 'Physics Teacher’s  Award (For Excelling in Physics)', 'es', NULL, 3),
(83, 'Late Vinayakprasad S. Pakhare Memorial Prize', 'es', NULL, 4),
(124, 'Standing First at TYBCOM', 'merit', 'Girl or Boy', 1),
(125, 'Securing highest marks in Financial Accounting& Auditing at TYBCOM', 'merit', 'Girl or Boy', 1),
(126, 'Standing first in FYJC Commerce', 'merit', 'Girl or Boy', 1),
(127, 'Standing first in SYJC Commerce', 'merit', 'Girl or Boy', 1),
(128, 'Shirish N. Panditrao Memorial Scholarship', 'merit', 'Topper in Marathi at University  Exam', 1),
(129, 'Ganit Pradnya Paritoshik', 'merit', 'Topper in Maths at University Exam', 1),
(130, 'T.S. Kokje Memorial Scholarship', 'merit', 'BMM course', 1),
(131, 'Ramesh Ravji Thakkar Endowment', 'merit', 'Needy/Deserving', NULL),
(132, 'Shri.  A. D. Bhorkar Endowment Scholarship', 'merit', 'Accountancy Topper', 1),
(133, 'Late Shri. Rajan Kashinath Dhotre Memorial Scholarship 	', 'merit', 'TYBcom Topper', 1),
(134, 'Alumni 93 (Commerce Batch) Scholarship', 'merit', 'Needy student of Commerce Faculty with consistent academic record', 1),
(135, 'Abha Moghe Endowment Scholarship', 'merit', NULL, 1),
(136, 'Rotary Trust Mulund South Scholarship', 'merit', 'Needy / Deserving', NULL),
(137, 'Late Smt. Vidya Madhav Thatte Endowment', 'merit', NULL, 4),
(138, 'Late Shri. D.G. Karandikar Memorial Scholarship', 'merit', 'Toppers in Mathematics - XI Science, XI Commerce, XII Science & XII Commerce', 4),
(139, 'Komal Keshav Khandekar Memorial Scholarship', 'merit', NULL, 1),
(140, 'Anant Jog Scholarship', 'merit', 'TY Zoology Topper', 1),
(141, 'Dr. Ms. Shubhangi Bhave', 'merit', 'TYBSC Physics Topper', 1),
(142, 'N.S.S.(Junior)', 'merit', 'College Best Volunteer', 1),
(143, 'Hiten Thakkar Scholarship', 'merit', 'Needy Student', NULL);
...
ALTER TABLE `achievements`
  ...
  ADD KEY `FK_ACHIEVEMENT_DEPT_ID` (`achievement_dept_sect_id`),
  ADD KEY `FK_ACHIEVEMENT_COMMITTEE_ID` (`achievement_committee_sect_id`);
...
--
-- Indexes for table `committee_has_committee_activities`
--
ALTER TABLE `committee_has_committee_activities`
  ADD KEY `FK_COMMITTEE_ACT_COMMITTEE_SECT_ID` (`committee_sect_id`),
  ADD KEY `FK_COMMITTEE_ACT_ACADEMIC_YEAR` (`committee_act_academic_year`);

--
-- Indexes for table `cp_belongs_to_dept_sect`
--
ALTER TABLE `cp_belongs_to_dept_sect`
  ADD KEY `FK_CP_BELONGS_TO_DEPT_SECT_ID` (`dept_sect_id`),
  ADD KEY `FK_CP_BELONGS_TO_DEPT_SECT_CP_ID` (`cp_id`);
...
ALTER TABLE `departmental_activities`
  ...
  ADD KEY `FK_DEPT_ACT_DEPT_ACADEMIC_YEAR` (`dept_act_academic_year`);
...
--
-- Indexes for table `other_pdf_belongs_to_academic_year`
--
ALTER TABLE `other_pdf_belongs_to_academic_year`
  ADD KEY `FK_OTHER_PDF_BELONGS_TO_ACADEMIC_YEAR_OTHER_PDF_ID` (`other_pdf_id`),
  ADD KEY `FK_OTHER_PDF_BELONGS_TO_ACADEMIC_YEAR_ACADEMIC_YEAR` (`academic_year`);
...
--
-- Indexes for table `other_pdf_cover_page_links`
--
ALTER TABLE `other_pdf_cover_page_links`
  ADD PRIMARY KEY (`other_pdf_cover_page_link`),
  ADD KEY `FK_MAG_COVER_PAGE_OTHER_PDF_ID` (`other_pdf_id`);
...
--
ALTER TABLE `aqar_criteria`
  MODIFY `aqar_criteria_number` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `other_pdfs`
  MODIFY `all_pdf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `reports`
  MODIFY `all_pdf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `scholarships`
  MODIFY `scholarship_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
...
--
ALTER TABLE `achievements`
  ADD CONSTRAINT `FK_ACHIEVEMENT_COMMITTEE_SEC_ID` FOREIGN KEY (`achievement_committee_sect_id`) REFERENCES `committee_belongs_to_clg_section` (`committee_clg_section_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_ACHIEVEMENT_DEPT_SECT_ID` FOREIGN KEY (`achievement_dept_sect_id`) REFERENCES `dept_belongs_to_clg_section` (`dept_sect_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `committee_has_committee_activities`
--
ALTER TABLE `committee_has_committee_activities`
  ADD CONSTRAINT `FK_COMMITTEE_ACT_ACADEMIC_YEAR` FOREIGN KEY (`committee_act_academic_year`) REFERENCES `academic_years` (`academic_year`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_COMMITTEE_ACT_COMMITTEE_SECT_ID` FOREIGN KEY (`committee_sect_id`) REFERENCES `committee_belongs_to_clg_section` (`committee_clg_section_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `cp_belongs_to_dept_sect`
--
ALTER TABLE `cp_belongs_to_dept_sect`
  ADD CONSTRAINT `FK_CP_BELONGS_TO_DEPT_SECT_CP_ID` FOREIGN KEY (`cp_id`) REFERENCES `college_personnel` (`cp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_CP_BELONGS_TO_DEPT_SECT_ID` FOREIGN KEY (`dept_sect_id`) REFERENCES `dept_belongs_to_clg_section` (`dept_sect_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `departmental_activities`
  ADD CONSTRAINT `FK_DEPT_ACT_DEPT_ACADEMIC_YEAR` FOREIGN KEY (`dept_act_academic_year`) REFERENCES `academic_years` (`academic_year`);
...
--
-- Constraints for table `other_pdf_belongs_to_academic_year`
--
ALTER TABLE `other_pdf_belongs_to_academic_year`
  ADD CONSTRAINT `FK_OTHER_PDF_BELONGS_TO_ACADEMIC_YEAR_ACADEMIC_YEAR` FOREIGN KEY (`academic_year`) REFERENCES `academic_years` (`academic_year`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_OTHER_PDF_BELONGS_TO_ACADEMIC_YEAR_OTHER_PDF_ID` FOREIGN KEY (`other_pdf_id`) REFERENCES `other_pdfs` (`all_pdf_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `other_pdf_cover_page_links`
--
ALTER TABLE `other_pdf_cover_page_links`
  ADD CONSTRAINT `FK_MAG_COVER_PAGE_OTHER_PDF_ID` FOREIGN KEY (`other_pdf_id`) REFERENCES `other_pdfs` (`all_pdf_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `syllabus_belongs_to_programmes_for_class`
  ADD CONSTRAINT `FK_SYLLABUS_CLASS_NAME` FOREIGN KEY (`class_name`) REFERENCES `class` (`class_name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_SYLLABUS_OTHER_PDF_ID` FOREIGN KEY (`other_pdf_id`) REFERENCES `other_pdfs` (`all_pdf_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_SYLLABUS_PROGRAME_ID` FOREIGN KEY (`prog_id`) REFERENCES `programmes` (`prog_id`);
COMMIT;
