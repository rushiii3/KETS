...
(NULL, 'Unfair Means'),
(NULL, 'Internal Complaints'),
(NULL, 'National Service Scheme'),
(NULL, 'Special Cell'),
(NULL, 'Student Council'),
(NULL, 'Academic Calendar and Prospectus'),
(NULL, 'Alumni Association'),
(NULL, 'Attendance including I-Card'),
(NULL, 'Staff Common Room and Canteen'),
(NULL, 'Digital Content Development and ICT Enabling'),
(NULL, 'Feedback'),
(NULL, 'Human Resource Development'),
(NULL, 'Internal Finance'),
(NULL, 'Institutional Social Responsibility'),
(NULL, 'Maintenance'),
(NULL, 'Purchase'),
(NULL, 'Research Promotion'),
(NULL, 'Support Staff Planning and Co-ordination'),
(NULL, 'Web-Designing and Uploading'),
(NULL, 'Women Development Cell'),
(NULL, 'Dimensions'),
(NULL, 'Green Initiative/ Hiker\'s Club/Environment Club/ Nature Club'),
(NULL, 'Literary Association and Mayur'),
(NULL, 'Sanskruti'),
(NULL, 'Science Association'),
(NULL, 'Counselling Cell'),
(NULL, 'Gymkhana'),
(NULL, 'Steering'),
(NULL, 'Discipline'),
(NULL, 'Examination and Results'),
(NULL, 'G.D. Kelkar Skill and Finishing School'),
(NULL, 'Career Guidance,Training and Placement Cell'),
(NULL, 'Library'),
(NULL, 'Student Support, Welfare and Remedial Coaching'),
(NULL, 'Development Programs'),
(NULL, 'Anti-Ragging'),
(NULL, 'Film and Photography Club'),
(NULL, 'Prize Distribution, Degree Distribution and G.D. Kelkar-R.A.Kulkarni Memorial Lecture Series'),
(NULL, 'Internal Quality Assessment and Control'),
(NULL, 'Support to Administration'),
(NULL, 'Swayam Shreyas and Life Long Learning'), (NULL, 'College Executive Committee'), (NULL, 'College Administration'), (NULL, 'College Development Committee'), (NULL, 'School Committee');
