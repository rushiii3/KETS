...
--
-- Host: localhost
-- Generation Time: Jul 30, 2024 at 07:38 PM
...
--
-- Table structure for table `magazine_cover_page_links`
--

CREATE TABLE `magazine_cover_page_links` (
  `other_pdf_id` int(11) NOT NULL,
  `other_pdf_cover_page_link` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `magazine_cover_page_links`
--

INSERT INTO `magazine_cover_page_links` (`other_pdf_id`, `other_pdf_cover_page_link`) VALUES
...
--
-- Indexes for table `magazine_cover_page_links`
--
ALTER TABLE `magazine_cover_page_links`
...
--
ALTER TABLE `other_pdfs`
  MODIFY `all_pdf_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
-- Constraints for table `magazine_cover_page_links`
--
ALTER TABLE `magazine_cover_page_links`
