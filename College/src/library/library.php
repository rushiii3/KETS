...
<!-- <script type="text/javascript" id="nada">
  let base_path = `${window.location.origin}/${window.location.href.split("/")[3]}`
    ...
    document.getElementById("header2_js").src = `${base_path}/College/src/js/common/header_2.js`;
    document.getElementById("header2_css").href = `${base_path}/College/src/css/common/header_2.css`;
...
<!--
////////////////////////////////
Other Custom animations and Css
/////////////////////////////////
-->
<style>
  @keyframes marquee {
