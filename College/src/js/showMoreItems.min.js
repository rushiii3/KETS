...
!(function (t) {
  ...
  (ShowMoreItems.prototype.init = function (t) {
    ...
    (ShowMoreItems.prototype.runData = function (o, r) {
      ...
      n.goOut ||
        $(o).after(
          '<div class="button-box relative mx-auto mt-5 flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:bg-sky-100 before:bg-gradient-to-b before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800 sm:w-max"><button class="addListData relative text-base font-semibold text-sky-600 dark:text-white">' +
            r.options.moreText +
            "</button></div>"
        ),
        $(o)
