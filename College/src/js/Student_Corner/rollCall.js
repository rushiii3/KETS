...
function fetchNotices_timeTable(year, value) {
  alert("year, value");
  $(document).ready(function () {

    $.ajax({
      url: "../../Components/Student_Corner/AJAX/fetchNotices_timeTable.php",
      type: "POST",
      cache: false,
      data: {
        year: year,
...
function fetchNotices_rollCall(year, value) {
  alert("year, value");
  $(document).ready(function () {

    $.ajax({
      url: "../../Components/Student_Corner/AJAX/fetchNotices_rollCall.php",
      type: "POST",
      cache: false,
      data: {
        year: year,
