<div>
    ...
    <div class="relative isolate flex flex-col justify-end overflow-hidden py-8  pt-80 sm:pt-48 lg:pt-80 mx-auto w-full ">
    ...
    <!--ABOUT SECTION-->
    <div class="h-auto my-10 grid grid-cols-1 items-center justify-center mx-auto md:grid-cols-3 gap-2 md:mx-10 overflow-hidden">
        <div class="order-last md:order-1 md:text-left lg:text-left text-center mx-auto p-10 col-span-2" data-aos="fade-right">
            <h1 class="text-violet-600 text-4xl font-extrabold  leading-none  md:text-4xl lg:text-5xl pb-9"> About Us</h1>
        ...
        <div class="md:order-2 mx-auto" data-aos="fade-left">
            <image alt="NextUI hero Image with delay" class="rounded md:max-h-[200px] lg:max-h-[300px] max-h-60 " src="../../assets/committee_icons/nss_svg.svg" />
        </div>
    </div>
    ...
    <!-- MOTTO SECTION -->
    <div class="h-[350px] max-h-[400px] bg-gray-100 flex flex-col items-center justify-center mx-auto w-[90vw] rounded-3xl translate-x-10" data-aos="zoom-in">
    ...
    <!--OBJECTIVES SECTION-->
    <div class=" w-[90dvw] h-auto px-[50px] my-10 grid grid-cols-1 items-center justify-center mx-auto md:grid-cols-2 gap-2 rounded-lg bg-slate-400 pb-12">

        <!--HEAD-->
        <div class=" text-center mx-auto p-1 mt-5  lg:col-span-2 md:col-span-2 col-span-1" data-aos="zoom-in-up">
            <h1 class="text-violet-600 text-4xl font-extrabold  leading-none  md:text-4xl lg:text-5xl pb-9"> Objectives</h1>
        </div>
    ...
    <!--Year Dropdown-->
    <div class="mx-auto  w-[90dvw] rounded-2xl  py-10  text-center px-2 bg-blue-300" data-aos="zoom-in">
    ...
    <!--yearly activities-->
    <div id="2019_2020" class=" max-w-[90dvw] bg-pink-600 mx-auto" data-aos="zoom-in-down">
            ...
            <div class="mx-auto max-w-7xl px-8 lg:px-12 pt-12">
                ...
                <div class="mx-auto mt-8 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-12 lg:mx-0 lg:max-w-none lg:grid-cols-4 ">
                    ...
                    <div class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 dark:bg-gray-700 px-8 py-8 pb-8 pt-80 sm:pt-48 lg:pt-80" data-aos="fade-up">
                        <img src="../../assets/committee_icons/nss_svg.svg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
                        <div class="absolute inset-0 -z-10 bg-gradient-to-t   from-gray-800 via-gray-900/10"></div>
                        <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-white/10"></div>
        ...
        <section class=" py-12 dark:bg-gray-50 dark:text-gray-800">
            <div class="container mx-auto space-y-12 grid  lg:grid-cols-4  md:grid-cols-2 grid-cols-1 bg-red-800 px-3 overflow-hidden gap-2 items-center justify-center py-7">
