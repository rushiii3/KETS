...
<!-- drawer component -->
<div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-screen h-screen p-4 overflow-y-auto transition-transform -translate-x-full  bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
