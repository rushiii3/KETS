                                ...
                                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_junior(\'' . $row['academic_year'] . '\', \'j\')">' . $row['academic_year'] . '</button>';
                                    ...
                                    <div class="max-w-full flex flex-col bg-white mt-10 border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden">
                                        <div class="p-4 md:p-5">
                                            ...
                                            <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="j_notices">
                                                <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="j_notice">
                                            ...
                                            <!-- Modal need to make dynamic under this in header part give two dropdown 1.Academic Year 2.Month for filter -->
                                            <div class=" flex  mt-2 ">
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                ...
                                <div id="default-tab-content1">
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile1" role="tabpanel" aria-labelledby="profile-tab1">
                                        <!-- Academic Year for Degree Aided college section -->
                                        <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_junior(\'' . $row['academic_year'] . '\', \'d\')">' . $row['academic_year'] . '</button>';
                                        ...
                                        <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                            <div class="p-4 md:p-5">
                                                <h3 class="text-base  text-gray-800 md:text-4xl dark:text-white">
                                                    Degree Aided College Notices
                                                </h3>
                                                <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="d_notices">
                                                    <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="d_notice">
                                    ...
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard1" role="tabpanel" aria-labelledby="dashboard-tab1">
                                        <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_junior(\'' . $row['academic_year'] . '\', \'s\')">' . $row['academic_year'] . '</button>';
                                        ...
                                        <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                            <div class="p-4 md:p-5">
                                                <h3 class="text-base   text-gray-800 md:text-4xl dark:text-white">
                                                    Degree SFC College Notices
                                                </h3>
                                                <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="s_notices">
                                                    <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="s_notice">
