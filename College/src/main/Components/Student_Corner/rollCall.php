                ...
                <div class="">
                    ...
                    <div id="tabContentExample" class="w-full">
                            ...
                            <div>
                                ...
                                <div id="default-tab-content">
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div class="flex mt-10 hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-hidden mx-auto px-5">
                                            <ul class="flex flex-wrap   text-center" id="default-tab1" data-tabs-toggle="#default-tab-content1" role="tablist">
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="profile-tab1" data-tabs-target="#profile1" type="button" role="tab" aria-controls="profile1" aria-selected="false">Time Table</button>
                                                </li>
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="dashboard-tab1" data-tabs-target="#dashboard1" type="button" role="tab" aria-controls="dashboard1" aria-selected="false">Roll Call</button>
                                                </li>
                                            </ul>
                                        ...
                                        <div id="default-tab-content1">
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile1" role="tabpanel" aria-labelledby="profile-tab1">
                                                <!-- Academic Year for Examination  section -->
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_timeTable(\'' . $row['academic_year'] . '\', \'d\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="d_timeTable">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="d_timeTable">
                                            ...
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard1" role="tabpanel" aria-labelledby="dashboard-tab1">
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_rollCall(\'' . $row['academic_year'] . '\', \'d\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="d_rollCall">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="d_rollCall">
                                    ...
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        ...
                                        <div class="flex mt-10 hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-hidden mx-auto px-5">
                                            <ul class="flex flex-wrap   text-center" id="default-tab2" data-tabs-toggle="#default-tab-content2" role="tablist">
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="profile-tab2" data-tabs-target="#profile2" type="button" role="tab" aria-controls="profile2" aria-selected="false">Time Table</button>
                                                </li>
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="dashboard-tab2" data-tabs-target="#dashboard2" type="button" role="tab" aria-controls="dashboard2" aria-selected="false">Roll Call</button>
                                                </li>
                                            </ul>

                                        </div>
                                        <div id="default-tab-content2">
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile2" role="tabpane2" aria-labelledby="profile-tab2">
                                                <!-- Academic Year for Examination  section -->
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_timeTable(\'' . $row['academic_year'] . '\', \'s\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="s_timeTable">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="s_timeTable">
                                            ...
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard2" role="tabpane2" aria-labelledby="dashboard-tab2">
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_rollCall(\'' . $row['academic_year'] . '\', \'s\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="s_rollCall">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="s_rollCall">
                        ...
                        <div class="mt-10 hidden bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full" id="dashboard-example" role="tabpanel" aria-labelledby="dashboard-tab-example">
                            ...
                            <div class="flex mt-10 hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-hidden mx-auto px-5">
                                            <ul class="flex flex-wrap   text-center" id="default-tab3" data-tabs-toggle="#default-tab-content3" role="tablist">
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="profile-tab3" data-tabs-target="#profile3" type="button" role="tab" aria-controls="profile3" aria-selected="false">Time Table</button>
                                                </li>
                                                <li class="me-2" role="presentation">
                                                    <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="dashboard-tab3" data-tabs-target="#dashboard3" type="button" role="tab" aria-controls="dashboard3" aria-selected="false">Roll Call</button>
                                                </li>
                                            </ul>

                                        </div>
                                        <div id="default-tab-content3">
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                                                <!-- Academic Year for Examination  section -->
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_timeTable(\'' . $row['academic_year'] . '\', \'j\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="j_timeTable">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="j_timeTable">
                                            ...
                                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard3" role="tabpanel" aria-labelledby="dashboard-tab3">
                                                <div class="flex hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-x-auto mx-auto">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<button class=" text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full hover:shadow-2xl hover:bg-blue-600" onclick="fetchNotices_rollCall(\'' . $row['academic_year'] . '\', \'j\')">' . $row['academic_year'] . '</button>';
                                                ...
                                                <div class="max-w-full flex flex-col bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 overflow-hidden mt-10">
                                                    <div class="p-4 md:p-5">
                                                        ...
                                                        <div class="w-full bg-gray-50 flex-col overflow-hidden overflow-y-hidden h-fit mt-5 text-left" id="j_rollCall">
                                                            <div class="flex w-full bg-gray-50 flex-col marque overflow-hidden overflow-y-hidden h-fit text-left p-4 space-y-2 gap-1 " id="j_rollCall">
