<div class="bg-gray-100 overflow-x-hidden mx-auto dark:bg-black" style="transition: all 2s ease">
    ...
    <div class="relative isolate flex flex-col  overflow-hidden py-2 md:h-[30rem] h-[25rem] mx-auto w-full items-center justify-center"> <img src="../../assests/college.png" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
        ...
        <div class="text-center z-1" data-aos="fade-up">
            <h1 class="md:text-7xl text-5xl font-bold tracking-tight text-white sm:text-6xl text-center px-[20px]">Research Conference </h1>
        </div>
    ...
    <nav aria-label="Breadcrumb" class="pl-16 mt-10" id="Breadcrumb">
        <ol class="flex items-stretch gap-2 list-none">
            ...
            <li class="flex items-center flex-1 gap-2"> <a href="#" aria-current="page" class="pointer-events-none max-w-[20ch] truncate whitespace-nowrap text-slate-400">Research Confrence</a> </li>
        </ol>
    </nav>
            ...
            <div class="">
                <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400" id="tabs-example" role="tablist">
                    <li class="me-2" role="presentation">
                        <a href="#" class="inline-block p-4 text-white bg-blue-700 rounded-lg  dark:bg-gray-800 dark:text-blue-500" id="profile-tab-example" type="button" role="tab" aria-controls="profile-example" aria-selected="false">2023-24
                        </a>
                    </li>
                    <li class="me-2" role="presentation">
                        <a href="#" id="dashboard-tab-example" type="button" role="tab" aria-controls="dashboard-example" aria-selected="false" class="inline-block p-4 rounded-lg">2022-23</a>
                    </li>
                </ul>
                        ...
                        <div>
                            <div class="mb-12 space-y-2 text-center">
                                <h2 class="text-4xl font-bold text-gray-800 md:text-5xl dark:text-white">
                                    Research Conference 2023-24

                                </h2>
                                <p class="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300">
                                    SFC DEPARTMENTS UNDER THE AEGIS OF IQAC ORGANISES ONE DAY INTERNATIONAL MULTIDISCIPLINARY CONFERENCE ON “SETTING BENCHMARKS : RESEARCH, INNOVATION, SUSTAINABILITY, ENTREPRENEURSHIP ” (ICMB-RISE-2024)
                                </p>
                            </div>
                            <!-- component -->
                            <div class="flex items-center justify-center p-12 pr-0 fixed bottom-0 right-0 z-50">

                                <div class="w-full">
                                    <div class="formbold-form-wrapper mx-auto hidden w-full max-w-[550px] rounded-lg border border-[#e0e0e0] bg-white">
                                        <div class="flex items-center justify-between rounded-t-lg bg-blue-500 py-4 px-9">
                                            <h3 class="text-xl font-bold text-white">For Inquiries, Contact Us</h3>
                                            <button onclick="chatboxToogleHandler()" class="text-white">
                                                <svg width="17" height="17" viewBox="0 0 17 17" class="fill-current ml-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="h-fit flex flex-col bg-gray-100">
                                                <div class="m-auto">
                                                    <div class="flex flex-col bg-gray-200 max-w-sm shadow-md py-4 px-4 md:px-2 rounded-md w-full">
                                                        <div class="flex flex-col md:flex-row ">

                                                            <div class="flex  text-center md:text-left">
                                                                <div class="font-medium text-lg text-gray-800">Dr Suresh Kadam <span> +919511858716</span></div>
                                                ...
                                                <div class="m-auto">
                                                    <div class="flex flex-col bg-gray-200 max-w-sm shadow-md py-4 px-4 md:px-2 rounded-md w-full">
                                                        <div class="flex flex-col md:flex-row ">
                                                            ...
                                                            <div class="flex  text-center md:text-left">
                                                                <div class="font-medium text-lg text-gray-800">Dr. Paresh More <span> +919819003404</span></div>
                                    ...
                                    <div class="mx-auto mt-12 flex max-w-[550px] items-center justify-end space-x-5">
                                        <button class="flex h-[70px] w-[70px] items-center justify-center rounded-full bg-blue-500 text-white" onclick="chatboxToogleHandler()">
                                            ...
                                            <span class="chat-icon">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 -960 960 960" fill="#FFFFFF">
                            ...
                            <div id="default-tab-content">
                                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <section class="py-12">
                                        <div class="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                                            <div class="mb-12 space-y-2 text-center">
                                                <h2 class="text-4xl font-bold text-gray-800 md:text-5xl dark:text-white"> TITLE </h2>
                                                <p class="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300"> SUBTITLE </p>
                                            </div>
                                        </div>
                                        <div class=" grid gap-8 sm:grid-cols-2 md:-mx-8 lg:grid-cols-3 md:px-10 list1 mt-10">
                                    ...
                                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10 ">
                                        <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                            <li class="me-2">
                                                <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="true" class="inline-block p-4 text-blue-600 rounded-ss-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500">Proposed Research Areas</button>
                                            </li>
                                            <li class="me-2">
                                                <button id="services-tab" data-tabs-target="#services" type="button" role="tab" aria-controls="services" aria-selected="false" class="inline-block p-4 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-300">Guidelines and links</button>
                                            </li>
                                            <li class="me-2">
                                                <button id="statistics-tab" data-tabs-target="#statistics" type="button" role="tab" aria-controls="statistics" aria-selected="false" class="inline-block p-4 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-300">Important Dates</button>
                                            </li>
                                        </ul>
                                        <div id="defaultTabContent">
                                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel" aria-labelledby="about-tab">
                                                <h2 class="mb-3 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Key Focus Areas for Research Proposals</h2>
                                                <!-- List -->
                                                <ul role="list" class="space-y-4 text-gray-500 dark:text-gray-400">
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        ...
                                                        <span class="leading-tight">Entrepreneurship</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Biotechnology</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Healthcare and Wellnes</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">HR and Marketing</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Finance</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Information Technology</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Pure Science</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Humanities and Social Sciences</span>
                                                    </li>

                                                </ul>
                                                <!-- <p class="mb-3 text-gray-500 dark:text-gray-400">Empower Developers, IT Ops, and business teams to collaborate at high velocity. Respond to changes and deliver great customer and employee service experiences fast.
                                            ...
                                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="services" role="tabpanel" aria-labelledby="services-tab">
                                                <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Essential Guidelines and Useful Links</h2>
                                                <!-- List -->
                                                <ul role="list" class="space-y-4 text-gray-500 dark:text-gray-400">
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                        ...
                                                        <span class="leading-tight">All the authors of the abstract are required to register, pay their registration fees, to avail certificate, upload their fee receipt and mandatory to join the whats app group.</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Participants presenting must ensure that the abstract should be related to the conference theme.</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">All the participants are requested to register online to confirm their participation.</span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Link for abstract template :<span class="text-blue-500 cursor-pointer  ">https://docs.google.com/document/d/1WCC3HxmRhY135NM16WBVYULEo6sNtn4H/edit </span></span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Email for submitting Research Abstracts and full paper : <span class="text-blue-500 cursor-pointer  ">imcb.rise@gmail.com </span></span>
                                                    </li>
                                                    <li class="flex space-x-2 rtl:space-x-reverse items-center">
                                                        <svg class="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                                        </svg>
                                                        <span class="leading-tight">Link for Registration : <span class="text-blue-500 cursor-pointer  "> https://forms.gle/DkmtQNUMgcmTi7aJ9 </span></span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="statistics" role="tabpanel" aria-labelledby="statistics-tab">
                                                <h2 class="mb-3 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Key Dates and Deadlines to Remember</h2>
                                                <dl class="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                                                    <div class="flex flex-col">
                                                        <dt class="mb-2 text-xl font-bold">10th February 2024 </dt>
                                                        <dd class="text-gray-500 dark:text-gray-400">Submission of abstract (Last Date)</dd>
                                                    </div>
                                                    <!-- <div class="flex flex-col">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <dt class="mb-2 text-xl font-bold">February 21, 2024</dt>
                                                        <dd class="text-gray-500 dark:text-gray-400">Event Date</dd>
                                                    </div>
                                                </dl>
                                            </div>
                                        </div>
                                    ...
                                    <section class="py-12 min-w-full">
                                        <div class="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                                            <div class="mb-12 space-y-2 text-center">
                                                ...
                                                </p>Discover highlights from our research initiatives and special projects through these snapshots.
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="mb-12 mt-5 space-y-2 text-center">
                                    ...
                                    <p class="lg:mx-auto lg:w-6/12 text-md text-gray-600 dark:text-gray-300">
                                        Discover how to participate in our research conference. Stay updated with essential details and announcements here.
                                    </p>
                                </div>
                                ...
                                <div class="flex mt-10 hide-scroll-bar lg:justify-center items-center gap-6 flex-nowrap overflow-hidden mx-auto px-5">
                                    <ul class="flex flex-wrap   text-center" id="default-tab1" data-tabs-toggle="#default-tab-content1" role="tablist">
                                        <li class="me-2" role="presentation">
                                            <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="profile-tab1" data-tabs-target="#profile1" type="button" role="tab" aria-controls="profile1" aria-selected="false">Indian Delegates</button>
                                        </li>
                                        <li class="me-2" role="presentation">
                                            <button class="bg-blue-500 text-nowrap px-5 py-3 text-sm shadow-sm font-bold tracking-wider text-white rounded-full hover:shadow-2xl hover:bg-blue-600" id="dashboard-tab1" data-tabs-target="#dashboard1" type="button" role="tab" aria-controls="dashboard1" aria-selected="false">Foreign Delegates</button>
                                        </li>
                                    </ul>
                                ...
                                <div id="default-tab-content1">
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile1" role="tabpanel" aria-labelledby="profile-tab1">
                                        ...
                                        <div class="flex flex-col justify-center items-center  h-fit">
                                            <div class="relative flex max-w-full h-fit w-full flex-col border-t-blue-600 shadow-sm rounded-xl  border-[1px] border-gray-200 bg-white bg-clip-border  shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none justify-between">
                                                <div class="flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100 dark:!bg-navy-700 dark:shadow-none">
                                                    <h4 class="text-lg font-bold text-navy-700 dark:text-white">
                                                        PARTICIPATION & PRESENTATION FEES [Indian Delegates]
                                                    </h4>

                                                </div>
                                                <div class="w-fit overflow-hidden px-4 md:overflow-x-hidden">
                                                    <table role="table" class="table-fixed border-separate -sm:hidden empty-cells-hidden mx-auto my-auto w-screen">
                                                        <thead>
                                                            <tr role="row">
                                    ...
                                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard1" role="tabpanel" aria-labelledby="dashboard-tab1">
                                        <div class="flex flex-col justify-center items-center  h-fit">
                                            <div class="relative flex max-w-full h-fit w-full flex-col rounded-[10px] border-[1px] border-gray-200 bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none justify-between">
                                                <div class="flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100 dark:!bg-navy-700 dark:shadow-none">
                                                    <h4 class="text-lg font-bold text-navy-700 dark:text-white">
                                                        PARTICIPATION & PRESENTATION FEES [Foreign Delegates]
                                                    </h4>
                                    ...
                                    <div class="flex flex-col justify-center items-center  h-fit m-4">
                                        <div class="relative flex max-w-full h-fit w-full flex-col border-t-blue-600 shadow-sm rounded-xl  border-[1px] border-gray-200 bg-white bg-clip-border  shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none justify-between">
                                            <div class="flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100 dark:!bg-navy-700 dark:shadow-none">
                                                <h4 class="text-lg font-bold text-navy-700 dark:text-white">
                                                    PAYMENT DETAILS
                                            ...
                                            <div class="w-fit overflow-hidden px-4 md:overflow-x-hidden">
                                                <table role="table" class="table-auto border-separate -sm:hidden  empty-cells-hidden mx-auto my-auto w-full">
                                                    <!-- <thead>
                                                            <tr role="row">
                                                                <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer">
                                                                    <div class="flex items-center justify-between pb-2 pt-4 text-start uppercase tracking-wide text-gray-600 sm:text-xs lg:text-xs px-4">
                ...
                <div class="mt-10 hidden bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full" id="dashboard-example" role="tabpanel" aria-labelledby="dashboard-tab-example">
                    <div>
                        <div class="mb-12 space-y-2 text-center">
                            <h2 class="text-4xl font-bold text-gray-800 md:text-5xl dark:text-white">
                                Research Conference 2022-23

                            </h2>
                            <p class="lg:mx-auto lg:w-6/12 text-gray-600 dark:text-gray-300">
                                FACULTY OF SCIENCE UNDER THE AEGIS OF IQAC ORGANISES ONE DAY INTERNATIONAL CONFERENCE ON
