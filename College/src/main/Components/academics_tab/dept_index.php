             ...
             <div class="list1 py-12 px-14 grid mx-auto gap-5 grid-cols-1 md:grid-cols-3  justify-center" id="junior" role="tabpanel" aria-labelledby="profile-tab">
                 <?php
                    ...
                    if ($result1->num_rows > 0) {
                     ...
                     <a href="../../Pages/academics_tab/Department.php?dept_sec_id=' . $dept_sect_id . '">
                     ...
                     <a href="../../Pages/academics_tab/Department.php?dept_sec_id=' . $dept_sect_id . '" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                         Read more
