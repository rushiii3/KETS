 <div>
     <div class="relative isolate flex flex-col overflow-hidden py-2 md:h-[25rem] h-[15rem] mx-auto w-full items-center justify-center">
         <img src="../../../assets/png/college.png" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
 ...
 <div class=" mx-auto">
     <div class="mb-2 border-b dark:border-none border-gray-200  mt-4 bg-slate-300 dark:bg-transparent overflow-hidden p-1" data-aos="fade-right">
     ...
     <div class=" mx-auto min-w-full " data-aos="fade-up">
         <div id="ok1">
             <div class="list1 py-12 px-14 grid mx-auto gap-5 grid-cols-1 md:grid-cols-3  justify-center" id="junior" role="tabpanel" aria-labelledby="profile-tab">
                 <?php
                    $query1 = "SELECT d.dept_name,ds.dept_sect_id FROM `departments` as d ,dept_belongs_to_clg_section as ds  WHERE d.dept_id=ds.dept_id and ds.college_sec_name='j'";
                    ...
                    if ($result1->num_rows > 0) {
                     ...
                     <a href="../../Pages/academics_tab/specific_department.php?dept_sec_id=' . $dept_sect_id . '">
                     ...
                     <a href="../../Pages/academics_tab/specific_department.php?dept_sec_id=' . $dept_sect_id . '" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                         Read more
