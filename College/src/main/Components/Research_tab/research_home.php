 ...
 <section class="relative py-12 md:py-12 bg-gray-100 dark:bg-black overflow-hidden m-10">
     ...
     <div class="relative container px-4 mx-auto">
         <div class="max-w-5xl mx-auto">
             ...
             <div class="text-center mt-10 w-full  mx-auto"> <button type="button" class="mx-auto text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" onclick="window.location.href='publication.php'">Click for more Details </button></div>
 ...
 <section class="m-10 py-12 lg:py-12 dark:bg-black bg-gray-100  overflow-hidden">
     <div class="container px-4 mx-auto">
         <div class="flex flex-wrap lg:items-center -m-8">
             ...
             <div class="text-center mt-10 w-full  mx-auto"> <button type="button" class="mx-auto text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" onclick="window.location.href='patent.php'">View Patents </button></div>
         </div>
     </div>
 </section>