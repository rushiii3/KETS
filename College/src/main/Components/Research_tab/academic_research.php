     ...
     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
         ...
         <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
             <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-black dark:border-gray-700">
                 ...
                 <li>
                     <a href="academic_research.php" class="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500" aria-current="page">Academic Research</a>
                 </li>
                 <li>
                 ...
                 <div class="flex w-full mx-auto text-left">
                     <div class="relative inline-flex items-center mx-auto align-middle">
                         <div class="text-center">
                             ...
                             <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-gray-500">Our Academic Research page serves as a platform for showcasing pioneering studies and insightful analyses across various disciplines, fostering a community committed to advancing knowledge and addressing global challenges.</p>
                                         ...
                                         <div class="p-5">
                                             <div class="overflow-hidden">
                                                 <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                                     <thead>
                                                         <tr>
                                                             <th scope="col" class="px-6 py-3 text-center text-xl font-medium text-gray-900 uppercase dark:text-neutral-500" colspan="2">Research Activity</th>
                                                         </tr>
                                                     </thead>
