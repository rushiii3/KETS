     ...
     <div class=" mx-auto min-w-full" data-aos="zoom-in">
         <div id="ok1">
             <div class="list1 py-12 px-14 grid mx-auto gap-5 grid-cols-1 md:grid-cols-3  justify-center" id="junior" role="tabpanel" aria-labelledby="profile-tab">
                 <?php
                    $query1 = "SELECT d.dept_name,d.dept_id FROM `departments` as d ,dept_belongs_to_clg_section as ds  WHERE d.dept_id=ds.dept_id and ds.college_sec_name='j'";
                    ...
                    if ($result1->num_rows > 0) {
                        while ($row1 = $result1->fetch_assoc()) {
                            ...
                            echo '
                            <div class=" min-w-fit sm:min-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  text-center" data-aos="fade-up" data-aos-duration="1500">
                     <a href="../../Pages/department/Department.php?d_id=' . $encoded_id . '">
                     ...
                     <a href="../../Pages/department/Department.php?d_id=' . $encoded_id . '" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                         Read more
         ...
         <div id="ok2">
             <div class="list1 py-12 px-14 grid mx-auto gap-5 grid-cols-1 md:grid-cols-3  justify-center" id="degree" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <!-- section 1-->
                 <?php
                    $query2 = "SELECT d.dept_name,d.dept_id FROM `departments` as d ,dept_belongs_to_clg_section as ds  WHERE d.dept_id=ds.dept_id and ds.college_sec_name='d'";
                    ...
                    if ($result2->num_rows > 0) {
                        while ($row2 = $result2->fetch_assoc()) {
                            ...
                            echo '
                            <div class=" min-w-fit sm:min-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  text-center" >
                     <a href="../../Pages/department/Department.php?d_id=' . $encoded_id . '">
                         <h5 class=" py-3 mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center"> Department of ' . $dept_name . '</h5>
                     </a>
                     <a href="../../Pages/department/Department.php?d_id=' . $encoded_id . '" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
         ...
         <div id="ok3">
             <div class="list1 py-12 px-14 grid mx-auto gap-5 grid-cols-1 md:grid-cols-3  justify-center" id="sfc" role="tabpanel" aria-labelledby="profile-tab">
                 ...
                 <!-- Card1 -->
                 <?php
                    $query3 = "SELECT d.dept_name,d.dept_id FROM `departments` as d ,dept_belongs_to_clg_section as ds  WHERE d.dept_id=ds.dept_id and ds.college_sec_name='s'";
