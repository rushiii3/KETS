...
<div class="h-auto my-10 grid grid-cols-1 items-center justify-center mx-auto md:grid-cols-2 gap-8 md:mx-16 p-1 overflow-hidden">
    ...
    <div class="h-auto my-16 grid grid-cols-1 items-center justify-center mx-auto md:grid-cols-2 gap-8 md:mx-16 p-1 overflow-hidden">
      ...
      <div data-aos="fade-left">
        <h1 class="text-violet-600 text-4xl font-extrabold  leading-none  md:text-4xl lg:text-5xl dark:text-white"> Cutting-edge Teaching and Inspiring Campus Life </h1>
        <p class="mt-3"> Delve into an enchanting visual journey through our captivating campus, dynamic student life, and state-of-the-art facilities. </p>
      </div>
    </div>
    <div class="h-auto my-16 grid grid-cols-1 items-center justify-center mx-auto md:grid-cols-2 gap-8 md:mx-16 p-1 overflow-hidden ">
    ...
    <div class="mx-auto max-w-2xl py-28 sm:py-28 lg:py-28 text-center px-2" data-aos="zoom-in">
      <h1 class="text-violet-600 text-4xl font-extrabold  leading-none  md:text-4xl lg:text-5xl dark:text-white"> Join Us </h1>
