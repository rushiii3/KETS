   ...
   <div class=" overflow-hidden">
     ...
     <marquee class="flex " onmouseover="this.stop();" onmouseout="this.start();">
       <div><a href="www.google.com" class="pr-24"> ipsum dolor sit amet.</a> <a href="" class="pr-24">Admission Reminder</a> <a href="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam, minima.</a></div>
   ...
   <div class="bg-no-repeat bg-cover bg-center relative h-5/6 " style="background-image: url(../../assets/png/college.png);">
     ...
     <div class="max-h-screen">
       <div class="min-h-fit flex justify-center">
         <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 items-center z-10 max-w-7xl mx-auto p-5">
           ...
           <div class="mx-0 max-w-fit flex rounded-2xl bg-indigo-700">
                   ...
                   <blockquote class="text-left ">
                     ...
                     <div class="relative m-5 p-5">
                       ...
                       <div class="text-sm mt-5 mx-5">
                         <p class="font-medium text-white">Prof. (Dr.) Preeta Nilesh</p>
                         <p class="mt-1 text-gray-300">Principal</p>
                       </div>
                     </div>
       ...
       <div class="max-w-fit text-center text-white  text-lg mt-0 overflow-hidden">
         <marquee  onmouseover="this.stop();" onmouseout="this.start();"><a href="#" class="mr-24"> ipsum dolor sit amet.</a><a href="#"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic consequatur, qui accusamus quos distinctio aperiam est corporis optio illum iste.</a></marquee>
