...
$fetch_magazines_stmt = "SELECT * FROM other_pdfs JOIN magazine_cover_page_links on magazine_cover_page_links.other_pdf_id= other_pdfs.all_pdf_id WHERE other_pdfs_type_name='magazine' ORDER BY all_pdf_title ASC";
    ...
    ****************/
    ...
    <div class="flex flex-col mt-12 mb-8 dark:text-white w-[100vw] px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-4 mt-12 w-full">
            ...
            <?php
            if ($fetch_magazines_query_result) {
                    ...
                    <div class="pdf_card_wrapper">
                        <div class="flex flex-col group hover:cursor-pointer pdf_card items-center">
                            <div class=" overflow-clip h-[95%] max-w-[75%] rounded-2xl">
                                <img src="<?php echo "../../../assets/mayur_magazine_cover_pages/" . $row["other_pdf_cover_page_link"] ?>" alt="mayur_magazine_cover_page" class="  group-hover:scale-110  transition-transform duration-500 ">
                            </div>
