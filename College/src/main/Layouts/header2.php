  ...
  <section class='flex justify-between border-b	border-gray-200	 items-center gap-4 relative py-3 px-1 min-h-[100px]'>
    ...
    <a href="#" class="flex items-center px-5">
      ...
      <div class="flex flex-col">
        <span class="self-center sm:text-lg text-xs font-semibold sm:whitespace-nowrap dark:text-white ">THE KELKAR EDUCATION TRUST'S <br> VINAYAK GANESH VAZE COLLEGE OF ARTS, <br> SCIENCE AND COMMERCE (AUTONOMOUS).</span>
      </div>
 ...
 -->
        <div id="collapseMenu" class='w-full max-xl:hidden xl:!block max-xl:fixed max-xl:before:fixed max-xl:before:bg-black max-xl:before:opacity-50 max-xl:before:inset-0 max-xl:before:z-50'>
          ...
          <ul class='xl:flex xl:justify-end gap-x-8 max-xl:space-y-3 max-xl:fixed max-xl:bg-white max-xl:w-1/2 max-xl:min-w-[400px] max-xl:top-0 max-xl:left-0 max-xl:p-6 max-xl:h-full max-xl:shadow-md max-xl:overflow-auto z-50'>
            ...
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Home</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Contact Us</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>About us</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Academics</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Student Corner</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Admissions</a>
            </li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>Our campus</a></li>
            <li class='max-xl:border-b border-pink-200 max-xl:py-3'><a href='javascript:void(0)' class='hover:text-blue-600 font-bold text-black text-[15px] block dark:text-white'>More</a></li>
          </ul>
        </div>
