<header id="header" class='border-b dark:text-white border-gray-200 bg-white dark:bg-black font-sans tracking-wide  z-50  inset-x-0 top-0  sticky transition-top duration-300 ease-in-out'>
  <section class='flex justify-between border-b	border-gray-200	 items-center gap-4 relative py-3 px-1 min-h-[100px]'>
    ...
    <div class="flex flex-col items-center justify-end">
      <ul class='flex space-x-8 w-full px-10 py-2 justify-end max-xl:hidden'>
        <li>
          <a href='javascript:void(0)' class='hover:text-pink-500 font-bold  dark:text-white text-black text-[15px] '>Alumni
          </a>
        </li>

        <li>
          <a href='javascript:void(0)' class='hover:text-pink-500 font-bold dark:text-white text-black text-[15px] '>Faculty
          </a>
        </li>

        <li>
          <a href='javascript:void(0)' class='hover:text-pink-500 font-bold dark:text-white text-black text-[15px] '>Committees
          </a>
        </li>

        <li>
          <a href='javascript:void(0)' class='hover:text-pink-500 font-bold dark:text-white text-black text-[15px] '>Report and surveys
          </a>
        </li>

        <li>
          <a href='javascript:void(0)' class='hover:text-pink-500 font-bold dark:text-white text-black text-[15px] '>Avail Documents
          </a>
        </li>
      </ul>
 ...
 -->
    ...
    <!-- <div class="lg:absolute lg:right-10 flex items-center ml-auto">
      <button
        class='px-4 py-2 text-[15px] rounded font-bold text-pink-400 hover:text-pink-500 border-2 border-pink-300 bg-transparent'>Order
        food</button>
      <div class="inline-block border-pink-300 border-l-2 ml-4 pl-4 cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.904 192.904" width='20px'
          class="cursor-pointer fill-[#ec4899] hover:fill-[#f03e97]">
          <path
  ...
  <!-- <div class='flex flex-wrap items-start gap-4 px-10 py-4 relative'>
    ...
    <div id="collapseMenu"
      ...
      <ul
        class='lg:flex lg:justify-end gap-x-8 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
        <li class='mb-6 hidden max-lg:block'>
          <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" class='w-36' />
          </a>
        </li>
        <li class='max-lg:border-b border-pink-200 max-lg:py-3'><a href='javascript:void(0)'
