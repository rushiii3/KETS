    ...
    <div class="flex w-full md:w-3/4 px-1 gap-8 flex-col justify-center">
        ...
        <div class="justify-evenly mb-5 px-16" id="backButton">
            <div class="flex justify-start items-center w-full gap-4">
                <svg id="backButton" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-9 md:size-14 hover:text-slate-400">
            ...
            <div class="nav-link py-2 relative ${
              ...
              ${
                element.hasSub
                  ...
                  : `<a class="relative top-[60px] md:text-3xl text-xl font-light hover:text-slate-400" href="">${element.name}</a>`
              }
              <div class="nav-item-wrapper"></div>
            </div>`;
            $("#extra1").append(data);
